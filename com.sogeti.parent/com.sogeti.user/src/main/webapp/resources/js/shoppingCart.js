...
shoppingCart.prototype.addFormFields = function(form, data) {
	if (data != null) {
		$.each(data, function(name, value) {
			if (value != null) {
				var input = $("<input></input>").attr("type", "hidden").attr(
						"name", name).val(value);
				form.append(input);
			}
		});
...
function userDetails(userId,firstName, middleName, lastName, addressLine1,
...
function randomGenerator(orderID, transactionID) {
